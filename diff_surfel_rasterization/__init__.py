...
class _RenderEquation(torch.autograd.Function):
    ...
    def backward(ctx, grad_pbr, grad_incident_dirs, grad_diffuse_light):
        base_color, roughness, metallic, normals, viewdirs, incidents_shs, direct_shs, visibility_shs, incident_dirs = (
            ctx.saved_tensors
        )
        debug = ctx.debug
...
def RenderEquation_complex(
    base_color, roughness, metallic, normals, viewdirs, incidents_shs, direct_shs, visibility_shs, sample_num
):
